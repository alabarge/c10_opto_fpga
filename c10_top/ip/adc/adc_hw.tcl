...
set_module_property DISPLAY_NAME "MAX11300 I/F"
...
add_interface_port adc_export cs_n export Output 1
add_interface_port adc_export mosi export Output 1
add_interface_port adc_export miso export Input 1
add_interface_port adc_export intb_n export Input 1
add_interface_port adc_export cnvtb_n export Output 1
